...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if((playPosition + 1 == targetPosition || playPosition - 1 == targetPosition) && currentlyPlaying)
            return;
        ...
        Log.d(TAG, String.valueOf(holder.postTitle.getText()));
        ...
        String mediaUrl = postObjects.get(targetPosition).getContentVideoUrl();
        if (mediaUrl != null) {
